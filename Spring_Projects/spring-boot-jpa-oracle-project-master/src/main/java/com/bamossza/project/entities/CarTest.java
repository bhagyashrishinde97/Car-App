...
public class CarTest implements Serializable {
	...
	@Column(name="CAR_ID_TEST_FEB_2024", unique=true, nullable=false, precision=10, scale=0)
	@Getter @Setter
	private Integer carId;

	@Column(name="CAR_BRAND_FEB_2024", nullable = true, length = 50)
	@Getter @Setter
	private String carBrand;

	@Column(name="CAR_MODEL_FEB_2024", nullable = true, length = 50)
	@Getter @Setter
